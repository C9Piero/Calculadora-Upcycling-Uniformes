...
# 2. Estilos profesionales (Tipografía más pulida)
st.markdown("""
    <style>
...
with col2:
    if st.session_state.data:
        ...
        # Aquí eliminamos el índice usando set_index
        st.dataframe(df[["Prenda", "Und", "Kg", "CO2"]].reset_index(drop=True), use_container_width=True)
